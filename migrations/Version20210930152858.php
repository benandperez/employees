 ...
 */
final class Version20210930152858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employees (id INT AUTO_INCREMENT NOT NULL, document_type_id INT DEFAULT NULL, sub_area_id INT DEFAULT NULL, first_names VARCHAR(50) NOT NULL, last_names VARCHAR(100) NOT NULL, document VARCHAR(30) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BA82C30061232A4F (document_type_id), INDEX IDX_BA82C300C2D71C68 (sub_area_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
